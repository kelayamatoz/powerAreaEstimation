...
set ICC_MAX_AREA                  "80"           	;# max_area value used during area optimization
...
## ODL flow variables
set ICC_DP_ODL_BLOCK_SDC_MAP_FILE		""		;# A map file for the blocks and the SDC file for each block 
