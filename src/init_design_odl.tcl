...
## The Milkyway libraries by default support 187 user defined layers in the tech file. The library
# can now support up to 4000 user defined layers in the tech file if desired.  To activate this
# extended layer mode uncomment this Tcl command before creating a new Milkyway library.
#
#	extend_mw_layers
#
# Once activated the library will be able to support up to 4000 user defined layers. The extended
# layer mode is permanent and cannot be reverted back to the 255 layer mode once activated.  
#
# For more information on the extended layer mode please refer to Module 1 of 
# Solvnet article #039343.
